		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product List",
									"targetURL": "#comlab2devproductlist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devproductlist-display": {
								"semanticObject": "comlab2devproductlist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.productlist",
									"url": sap.ui.require.toUrl("com/lab2dev/productlist")
								}
							}
						}
					}
